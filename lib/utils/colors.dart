...
class AppColors {
  static final Color textColor = const Color.fromRGBO(0, 0, 0, 0.70); //usefull
  static final Color mainColor = const Color.fromRGBO(0, 0, 0, 0.75); //usefull
  ...
  static final Color signColor = const Color(0xFF2D8F95); //usefull
  ...
  static final Color bgColor = const Color(0xFFE5E5E5); //usefull
  static final Color boxgColor = const Color(0xFF50C2C9); //usefull
